...
the Toast and Modal close buttons bind their box and glyph to the icon scale
rather than drawing at a raw size. haus#55 added four, the nineteenth component
